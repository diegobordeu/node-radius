...
Radius.decode = function(args) {
  ...
  // console.log(ret, 'rettttttttttttttt');
  ...
  // console.log(ret, 'ret222222222222222222');
  this.authenticator = ret.authenticator = packet.slice(AUTH_START, AUTH_END);
  this.no_secret = args.no_secret;
  this.secret = args.secret;
  // console.log(this.authenticator,'autentificadorrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr');
  ...
  // console.log(uses_random_authenticator, 'request code just before important if');
  // console.log(!uses_random_authenticator[ret.code], is_request_code[ret.code], !args.no_secret, ret.code);
    if (!uses_random_authenticator[ret.code] && is_request_code[ret.code] && !args.no_secret){
    // console.log( 'entro al if importante .......');
    ...
    if (checksum.toString() != this.authenticator.toString()) {
      console.log('entro a el if mismatch');
